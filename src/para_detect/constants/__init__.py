...
DEBERTA_CONFIG_FILE_PATH = BASE_CONFIG_DIR / "deberta_config.yaml"
TRAINING_CONFIG_FILE_PATH = BASE_CONFIG_DIR / "training_config.yaml"
AWS_CONFIG_FILE_PATH = BASE_CONFIG_DIR / "aws_config.yaml"
